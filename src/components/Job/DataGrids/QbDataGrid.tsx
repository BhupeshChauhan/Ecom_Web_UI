...
import NoData, { NoDataQB } from "../../Nodata";
import RelativeTime from "../../../utils/RelativeTime";
import MessageDialog from "../../../utils/MessageDialog";
import { QBCategoryCard } from "../Cards/QBCategoryCard";
import QBQuestionForm from "../../Form/QBQuestionForm";
import QBCategoryForm from "../../Form/QBCategoryForm";
import useModal from "../../../hooks/useModal";
const QbDataGrid = ({ status, ModalComp, setOpenModal }) => {
  ...
  return (
    <div>
      ...
      <Datagrid
        ...
        variant="ssr2"
        getApi={`${import.meta.env.VITE_API_JOB_BASE_URI}/jobs/question-categories?`}
        defaultView="grid"
        unableDefaultSort={true}
        showSelectAction={false}
        showChangeButton={false}
        auth={token}
        noDataComp={<NoDataQB setOpenModal={setOpenModal} />}
      />
