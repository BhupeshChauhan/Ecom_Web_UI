...
const BasicSignUp = ({
  ...
  return (
    <div className="flex relative flex-wrap h-screen">
      <img
        className="-z-1 absolute top-0 h-full w-full object-cover opacity-90 image-style-align-center"
        src={previewImg}
      />
      <div className="flex w-full flex-col md:w-[35%] bg-white z-10 rounded-r-3xl">
